...
from procela.core.assessment import AnomalyResult, TrendResult
...
class TestVariableEpistemic:
    ...
    def test_frozen_dataclass(self):
        ...
        epistemic = VariableEpistemic(
            key=None, reasoning=None, stats=stats, anomaly=anomaly, trend=trend
        )
    ...
    def test_fields_have_correct_types(self):
        ...
        assert type_hints["stats"] == "StatisticsResult"
    ...
    def test_edge_cases(self):
        ...
        epistemic = VariableEpistemic(
            key=None, reasoning=None, stats=empty_stats, anomaly=None, trend=None
        )
