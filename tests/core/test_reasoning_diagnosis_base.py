...
from procela.core.reasoning import Diagnoser
...
class TestDiagnoser:
    ...
    def test_concrete_subclass_must_have_name(self) -> None:
        ...
        class NamelessDiagnoser(Diagnoser):
            ...
            def diagnose(self, view: VariableEpistemic) -> DiagnosisResult:
    ...
    def test_diagnose_receives_VariableEpistemic(self) -> None:
        """Test that diagnose receives VariableEpistemic parameter."""
    ...
    def test_diagnose_with_real_VariableEpistemic(self) -> None:
        """Test diagnose with actual VariableEpistemic interface."""
        ...
        view_minimal = Mock(spec=VariableEpistemic)
        ...
        # Test with full view
        view_full = Mock(spec=VariableEpistemic)
    ...
    def test_diagnose_with_invalid_input(self) -> None:
        ...
        view_incomplete = Mock(spec=VariableEpistemic)
        ...
        view_valid = Mock(spec=VariableEpistemic)
    ...
    def test_abstract_method_exception_message(self) -> None:
        ...
        try:
            method(instance, Mock(spec=VariableEpistemic))
