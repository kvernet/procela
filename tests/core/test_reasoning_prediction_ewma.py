...
def mock_view_with_ewma():
    """Provides a mock VariableEpistemic with ewma statistic."""
    # Create nested mock structure matching epistemic.stats.ewma
    mock_stats = Mock(spec=StatisticsResult)
    mock_stats.ewma = 42.5
    mock_stats.value = 43.0
    mock_stats.confidence = 0.5
...
def mock_view_with_none_ewma():
    """Provides a mock VariableEpistemic with ewma = None."""
    mock_stats = Mock(spec=StatisticsResult)
